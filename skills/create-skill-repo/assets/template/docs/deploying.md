...
- Consumers run `npx skills add {{GITHUB_OWNER}}/{{REPO_NAME}}` — the CLI
...
gh repo edit {{GITHUB_OWNER}}/{{REPO_NAME}} --visibility public --accept-visibility-change-consequences
